export default {
  ...
  pages: {
    ...
    dns: {
      ...
      placeholderCIDR: '例：1.1.1.1/32',
      placeholderCountryCode: '例：CN',
      placeholderGeosite: '例：gfw'
    },
    sniffer: {
      title: '域名嗅探设置',
  ...
  settings: {
    ...
    appearance: {
      ...
      floatingWindowSize: '悬浮窗大小',
      floatingWindowSizeSmall: '小',
      floatingWindowSizeDefault: '默认',
      ...
      customFloatingWindowSizeHelp:
        '第一个输入框是宽度，第二个是高度。最小值：宽度 {{minWidth}}，高度 {{minHeight}}。如果输入更小的值，会自动重置到最小值。',
      width: '宽度',
      height: '高度',
  ...
  dns: {
    ...
    fallbackResolver: '后备解析器',
    fallbackFilterGeoIP: '后备过滤 GeoIP',
    fallbackFilterGeoIPCode: '后备过滤 GeoIP 国家代码',
    fallbackFilterDomain: '后备过滤域名',
    fallbackFilterIPCIDR: '后备过滤 IP CIDR',
    fallbackFilterGeoSite: '后备过滤 GeoSite',
    fallbackFilterExtra: '额外 fallback-filter (JSON)',
    fallbackFilterExtraPlaceholder: '{\n  \"my-key\": true\n}',
    fallbackFilterExtraFormatError: '额外 fallback-filter 必须是合法的 JSON',
    fallbackFilterExtraObjectError: '额外 fallback-filter 必须是 JSON 对象',
    applyFallbackFilterTemplate: '模板',
    fallbackFilterTemplateDocsCn: '文档 / CN 示例',
    fallbackFilterTemplateDocsCnDesc: '官方 Mihomo 风格的 CN 过滤示例。',
    fallbackFilterTemplateLocalRu: '本地 / RU',
    fallbackFilterTemplateLocalRuDesc: '按 RU GeoIP 代码让 RU 流量走本地解析。',
    fallbackFilterTemplateLocalUs: '本地 / US',
    fallbackFilterTemplateLocalUsDesc: '按 US GeoIP 代码让 US 流量走本地解析。',
    fallbackFilterTemplateGlobalServices: '全球服务',
    fallbackFilterTemplateGlobalServicesDesc: '面向主要全球平台服务的后备过滤。',
    fallbackFilterTemplateMinimal: '最小',
    fallbackFilterTemplateMinimalDesc: '仅保留保留地址保护和一个后备解析器。',
    previewFallbackResolvers: '预览 Fallback Resolvers',
    previewFallbackFilter: '预览 Fallback Filter',
  ...
  profile: {
    ...
    editRules: {
      ...
      ruleTypeDescriptions: {
        DOMAIN: '精确匹配域名。',
        'DOMAIN-SUFFIX': '按域名后缀匹配，包括子域名。',
        'DOMAIN-KEYWORD': '匹配包含指定关键字的域名。',
        'DOMAIN-REGEX': '使用正则表达式匹配域名。',
        GEOSITE: '匹配 geosite 分类中的域名。',
        GEOIP: '按国家或地区匹配目标 IP 地址。',
        'SRC-GEOIP': '按国家或地区匹配源 IP 地址。',
        'IP-ASN': '按 ASN 匹配目标 IP 地址。',
        'SRC-IP-ASN': '按 ASN 匹配源 IP 地址。',
        'IP-CIDR': '按 CIDR 网段匹配目标 IP 地址。',
        'IP-CIDR6': '按 CIDR 网段匹配目标 IPv6 地址。',
        'SRC-IP-CIDR': '按 CIDR 网段匹配源 IP 地址。',
        'IP-SUFFIX': '按后缀网段匹配目标 IP 地址。',
        'SRC-IP-SUFFIX': '按后缀网段匹配源 IP 地址。',
        'SRC-PORT': '按源端口匹配连接。',
        'DST-PORT': '按目标端口匹配连接。',
        'IN-PORT': '匹配入站监听端口。',
        DSCP: '按 DSCP 值匹配数据包。',
        'PROCESS-NAME': '精确匹配进程名称。',
        'PROCESS-PATH': '精确匹配进程可执行文件路径。',
        'PROCESS-NAME-REGEX': '使用正则表达式匹配进程名称。',
        ...
        'IN-USER': '匹配已认证的入站用户。',
        'IN-NAME': '匹配入站名称。',
        'SUB-RULE': '应用引用的子规则表达式。',
        'RULE-SET': '匹配外部 rule-set 提供者中的条目。',
        AND: '仅当所有嵌套规则都匹配时才匹配。',
        OR: '任一嵌套规则匹配时即匹配。',
        NOT: '对嵌套规则结果取反。',
        MATCH: '匹配所有流量的兜底规则。'
