export default {
  ...
  pages: {
    ...
    dns: {
      ...
      placeholderCIDR: 'e.g.: 1.1.1.1/32',
      placeholderCountryCode: 'e.g.: CN',
      placeholderGeosite: 'e.g.: gfw'
    },
    sniffer: {
  ...
  dns: {
    ...
    fallbackFilterIPCIDR: 'Fallback Filter IP CIDR',
    fallbackFilterGeoSite: 'Fallback Filter GeoSite',
    fallbackFilterExtra: 'Fallback Filter Extra (JSON)',
    fallbackFilterExtraPlaceholder: '{\n  \"my-key\": true\n}',
    fallbackFilterExtraFormatError: 'Extra fallback-filter must be valid JSON',
    fallbackFilterExtraObjectError: 'Extra fallback-filter must be a JSON object',
    applyFallbackFilterTemplate: 'Templates',
    fallbackFilterTemplateDocsCn: 'Docs / CN Example',
    fallbackFilterTemplateDocsCnDesc: 'Official Mihomo-style fallback example for CN filtering.',
    fallbackFilterTemplateLocalRu: 'Local / RU',
    fallbackFilterTemplateLocalRuDesc: 'Keeps RU traffic local, fallback by RU GeoIP code.',
    ...
    previewFallbackFilter: 'Preview Fallback Filter',
  ...
  profile: {
    ...
    editRules: {
      ...
      instructions3: '3. Select a route and click Add Rule',
      ...
      ruleTypeDescriptions: {
        ...
        'DOMAIN-SUFFIX': 'Matches domains by suffix, including subdomains.',
        'DOMAIN-KEYWORD': 'Matches domains containing the specified keyword.',
        'DOMAIN-REGEX': 'Matches domains using a regular expression.',
        GEOSITE: 'Matches domains included in a geosite category.',
        GEOIP: 'Matches destination IP addresses by country or region.',
        'SRC-GEOIP': 'Matches source IP addresses by country or region.',
        'IP-ASN': 'Matches destination IP addresses by ASN.',
        'SRC-IP-ASN': 'Matches source IP addresses by ASN.',
        'IP-CIDR': 'Matches destination IP addresses by CIDR range.',
        'IP-CIDR6': 'Matches destination IPv6 addresses by CIDR range.',
        'SRC-IP-CIDR': 'Matches source IP addresses by CIDR range.',
        'IP-SUFFIX': 'Matches destination IP addresses by suffix range.',
        'SRC-IP-SUFFIX': 'Matches source IP addresses by suffix range.',
        'SRC-PORT': 'Matches connections by source port.',
        'DST-PORT': 'Matches connections by destination port.',
        'IN-PORT': 'Matches the inbound listening port.',
        DSCP: 'Matches packets by DSCP value.',
        'PROCESS-NAME': 'Matches an exact process name.',
        'PROCESS-PATH': 'Matches an exact process executable path.',
        'PROCESS-NAME-REGEX': 'Matches process names using a regular expression.',
        'PROCESS-PATH-REGEX': 'Matches process paths using a regular expression.',
        NETWORK: 'Matches the transport protocol.',
        UID: 'Matches by operating system user ID.',
        'IN-TYPE': 'Matches the inbound type.',
        'IN-USER': 'Matches the authenticated inbound user.',
        'IN-NAME': 'Matches the inbound name.',
        'SUB-RULE': 'Applies a referenced sub-rule expression.',
        'RULE-SET': 'Matches entries from an external rule-set provider.',
        AND: 'Matches only when all nested rules match.',
        OR: 'Matches when any nested rule matches.',
        NOT: 'Inverts the result of the nested rule.',
        MATCH: 'Fallback rule that matches everything.'
      }
    },
    openFile: 'Open File',
    delete: 'Delete',
